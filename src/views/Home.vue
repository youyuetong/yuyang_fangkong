  ...
  <div>
    ...
    <el-container>
      <el-header class="homeHeader">
        ...
        <span class="el-dropdown-link">{{user.username}}<i><img src="../assets/touxiang.jpg"></i>
        </span>
        ...
        <el-aside width="180px" ><!-- style="background-color: rgb(238, 241, 246)" -->
          ...
          >
            ...
            <el-submenu index="2">
              ...
              <el-menu-item index="/test1">用户管理</el-menu-item>
              <el-menu-item index="/test2">医护人员</el-menu-item>
              <el-menu-item index="/test2">管理员管理</el-menu-item>
            </el-submenu>

            <el-submenu index="3">
              <template slot="title"><i class="el-icon-message"></i>业务管理</template>
              <el-menu-item index="/test1">战役动态</el-menu-item>
            ...
            <el-submenu index="4">
              ...
              <el-menu-item index="/test1">菜单管理</el-menu-item>

<template>
    <div>
        <div class="input">
            <el-input placeholder="请输入角色名称" v-model="roletitle" @keyup.enter.native="searchEnterFun" class="input2" clearable>
        ...
        <el-card class="cardnurse">
            ...
            <el-dialog :title="titlerufeteMap[rufetitle]"  :visible.sync="dialogrufeVisible" width="650px" @close="clearfeild">
                <el-form :model="rufeteform" :rules="rules" ref="rufeteform">
                    ...
                    <el-form-item label="资源" :label-width="formLabelWidth" prop="source">
